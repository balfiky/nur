...
Nothing here filters or vetoes your picks. The executor will run whatever you choose. If the tool itself rejects your call (bad path, network error, missing argument), the result will say so and your turn continues normally.

## Examples

User says something you want to remember later:
```json
[{"tool_name": "self.note", "arguments": {"topic": "user_preferences", "text": "Paco prefers Python over Ruby."}, "rationale": "durable memory"}]
```
